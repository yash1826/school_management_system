...
public class Main extends Frame implements ActionListener {
    ...
    private TextArea taDisplay; // Added reference to TextArea
    ...
    public void actionPerformed(ActionEvent evt) {
        ...
        if (result != null && !result.isEmpty()) {
            ...
            String op = sbStr.toString().trim();
            if (!op.isEmpty()) {
                taDisplay.setText(op);
            } else {
                taDisplay.setText("Translation not found.");
            }
        } else {
            taDisplay.setText("Translation error or no result.");
        }
    }
    }
...
class Translate
{
    ...
    static final String DB_URL = "jdbc:mysql://localhost/nlp?useUnicode=true&characterEncoding=UTF-8";
